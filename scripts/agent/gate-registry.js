const GATES = {
  ...
  unit: { command: () => 'npm test -- --configLoader runner --maxWorkers=1' },
  ...
  'scripts-unit': { command: () => 'npm test -- --configLoader runner --maxWorkers=1' },
  'failure-paths': { command: () => 'npm test -- --configLoader runner --maxWorkers=1' },
